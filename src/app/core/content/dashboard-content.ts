export const intro = (): string => {
    return $localize`:tool intro:On many farms or plantations, at least some workers do not earn a living wage. There is a gap between the actual wage paid and a living wage. In order to advance the payment of living wages, GIZ developed the Living Wage Costing Tool. Based on the output of the IDH Salary Matrix the GIZ Living Wage Costing Tool provides various calculations to help you analyse the direct cost implications for producers to pay workers a living wage. It therefore allows the producer to determine additional costs of paying a living wage at farm level.'`;
};

export const aboutTitle = (): string => {
    return $localize`:about title:About the tool`;
};

export const howTitle = (): string => {
    return $localize`:how title:How does it work?`;
};

export const aboutMarkdown = (): string => {
    return $localize`:about body:
...
export const howMarkdown = (): string => {
    return $localize`:how body:
